...
public class Utility {
    ...
    public static void showCustomToast(Context context, String str, int i) {
        ...
        if (i == 120) {
            view.getBackground().setColorFilter(ContextCompat.getColor(context, R.C0644color.colorToastSuccess), Mode.SRC_IN);
        } else if (i == 121) {
            view.getBackground().setColorFilter(ContextCompat.getColor(context, R.C0644color.colorToastError), Mode.SRC_IN);
        }
        ((TextView) view.findViewById(16908299)).setTextColor(ContextCompat.getColor(context, R.C0644color.colorWhite));
        makeText.show();
    }
